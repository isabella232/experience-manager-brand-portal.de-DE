...
Um eine Anforderung einzureichen, klicken Sie **in einem Artikel** auf den Link eines Problems protokollieren, wodurch ein Problem in github geöffnet wird. Geben Sie einen Titel und eine Beschreibung an und klicken **Sie dann auf Neue Ausgabe senden**.

To request minor updates, click the **Edit this page** link in an article, which opens the source article in GitHub. Verwenden Sie die GitHub-Benutzeroberfläche, um Ihre Aktualisierungen vorzunehmen. See the general [Adobe Docs contributor guide](https://docs.adobe.com/help/en/contributor/contributor-guide/introduction.html) for more information.
