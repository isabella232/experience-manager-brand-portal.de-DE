...
## Neue Funktionen in 6.4.6 {#what-s-new-in-646}

### Neue Funktionen {#new-feature}

Diese Version umfasst die folgenden neuen Funktionen:

* Captcha für die Anmeldung beim Brand Portal.

### Verbesserungen {#enhancements-646}

Diese Version von Brand Portal umfasst die folgenden Verbesserungen:

* AEM Assets wird jetzt über Adobe I/O mit dem Markenportal konfiguriert, das ein IMS-Token zur Autorisierung Ihres Markenportals-Mandanten erhält.
...
* Dropdown-Werte für Metadatenschemas sind in den Asset-Eigenschaften nicht sichtbar.

* Metadaten-Unterschema zeigen keine Registerkarten basierend auf dem MIME-Typ in den Asset-Eigenschaften an.
...
* Für veröffentlichte Assets wird kein Vorschaubild angezeigt.

* Benutzer kann Assets, die ein einzelnes Anführungszeichen im Namen enthalten, nicht veröffentlichen oder die Veröffentlichung rückgängig machen.
