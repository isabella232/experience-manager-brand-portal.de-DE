...
| [Konfigurieren der von AEM Assets mit Brand Portal](../using/configure-aem-assets-with-brand-portal.md) | Replizieren von Brand Portal mit AEM Assets, um Assets zu veröffentlichen. |
