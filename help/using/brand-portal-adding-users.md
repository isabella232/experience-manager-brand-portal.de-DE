...
1. Führen Sie in Admin Console einen der folgenden Schritte aus, um einen neuen Benutzer zu erstellen:
   ...
   * Klicken Sie oben in der Symbolleiste auf **[!UICONTROL Benutzer]**. Auf der Seite [!UICONTROL Benutzer] ist in der Leiste auf der linken Seite standardmäßig [!UICONTROL Benutzer] ausgewählt. Klicken Sie auf **[!UICONTROL Benutzer hinzufügen]**.
...
1. Gehen Sie wie folgt vor, um mehrere Benutzer zum Produktprofil hinzuzufügen:
   ...
   * Choose **[!UICONTROL ellipsis (...) &gt; Add users by CSV]**.
   ![Mehrere Benutzer auf einmal hinzufügen](assets/admin_console_addbulkusers.png)
...
1. Auf der Seite [!UICONTROL Benutzer] ist in der Leiste auf der linken Seite standardmäßig [!UICONTROL Benutzer] ausgewählt. Klicken Sie auf den Benutzernamen des Benutzers, dem Sie Administratorrechte gewähren möchten.
...
1. Auf der Seite [!UICONTROL Benutzerrollen] ist die Registerkarte [!UICONTROL Benutzer] standardmäßig ausgewählt. Für den Benutzer, dessen Rolle Sie ändern möchten, wählen Sie **[!UICONTROL Bearbeiter]** oder **[!UICONTROL Betrachter]** in der Dropdown-Liste **[!UICONTROL Rolle]** aus.
