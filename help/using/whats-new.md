...
description: Neue Funktionen und Verbesserungen in Version 2032.10.0
...
Brand Portal 2023.10.0 ist eine interne Version, mit der die kritischen Probleme behoben werden. Weitere Informationen finden Sie in den aktuellen [Brand Portal-Versionshinweisen](brand-portal-release-notes.md).

## Änderungen in Version 2023.08.0 {#what-changed-in-August-2023}

Brand Portal 2023.08.0 ist eine interne Version, mit der die kritischen Probleme behoben werden. Weitere Informationen finden Sie in den aktuellen [Brand Portal-Versionshinweisen](brand-portal-release-notes.md).

## Änderungen in Version 2023.05.0 {#what-changed-in-May-2023}

Brand Portal 2023.05.0 ist eine interne Version, mit der die kritischen Probleme behoben werden. Weitere Informationen finden Sie in den aktuellen [Brand Portal-Versionshinweisen](brand-portal-release-notes.md).
...
Brand Portal 2022.02.0 ist eine interne Version, mit der die kritischen Probleme behoben werden: Weitere Informationen finden Sie in den aktuellen [Brand Portal-Versionshinweisen](brand-portal-release-notes.md).
...
* In der Kartenansicht werden jetzt Datum-/Zeitstempel angezeigt, wenn Sie den Mauszeiger über die Datumsbeschriftung bewegen.
...
* Sie können auch Suchfilter zur Omni-Suche hinzufügen, um Ihre Suche weiter einzugrenzen und zu beschleunigen.
